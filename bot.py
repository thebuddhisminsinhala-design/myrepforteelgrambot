...
BACKUP_CHANNEL_LINK = "https://t.me/+mw9dB4ER2SQ3ODk1"
BACKUP_CHANNEL_USERNAME = "-1003955180555"
...
async def join_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if in_main and in_backup:
        ...
        if original_query:
            ...
            await context.bot.send_message(chat_id=chat_id, text="කරුණාකර නැවත ඔබගේ ප්‍රශ්නය ටයිප් කරන්න.")
    else:
...
async def process_diagram_request(update: Update, context: ContextTypes.DEFAULT_TYPE, query_text: str):
    ...
    # Send waiting message properly depending on if it's a regular message or callback query
    if update.message:
